...
OUT_JSON="${HOME}/.cache/nim/tachidater_r/tachidater.json"
...
"${STRIP}"  --discard-all --strip-all './tachidater'

if ! [ -d './builds/android-x86_64' ]; then
	mkdir --parent './builds/android-x86_64'
fi

mv './tachidater' './builds/android-x86_64/tachidater-android-x86_64'
...
echo "Build successful: $(realpath './builds/android-x86_64/tachidater-android-x86_64')"
